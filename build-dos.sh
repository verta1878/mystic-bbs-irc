#!/usr/bin/env bash
# ============================================================
#  Mystic 1.10 A38 fork - DOS build  (FPC 2.6.2, i386-go32v2)
...
#  cross compiler + go32v2 RTL + PATCHED binutils that reads FPC's COFF output;
#  see libs/dos-binutils-patch/).
#
