...
Begin
	...
	// smtpRefuseForeign is loaded once at MIS startup from data/mis.ini
	// ([SMTP] RefuseForeign, default true = A38 behavior).
	If smtpRefuseForeign and (InDomain <> bbsCfg.iNetDomain) and (Result = False) Then Begin
...
Begin
  ...
  For MsgLoop := 0 To ToList.Count - 1 Do Begin
    ...
    MsgBase^.SetTime     (TimeDos2Str(CurDateDos, 0));
