...
Var
  ...
  Header   : String[128];
  BufStr   : String[128];
  Chunks   : LongInt;   // was Word: overflowed at 64KB (msg byte count before DIV 128), corrupting the QWK block count
  MsgAdded : LongInt;
  LastRead : LongInt;
  QwkIndex : LongInt;
  TooBig   : Boolean;
...
Var
  QwkBlock   : String[128];
  QwkHeader  : QwkDATHdr;
  Chunks     : LongInt;    // was SmallInt: >32767 blocks (~4MB msg) wrapped negative -> loop skipped
  Line       : String;
  LineCount  : SmallInt;
  IsControl  : Boolean;
  GotControl : Boolean;
