...
Type
  TTermAnsi = Class
    Screen   : TAbstractConsole;
    WasValid : Boolean;
  Private
    Client  : TAbstractConsole;
    State   : Byte;
    SavedX  : Byte;
    SavedY  : Byte;
    Options : String;
  ...
  Public
    Constructor Create (Var Con: TAbstractConsole);
    Destructor  Destroy; Override;
    Procedure   Process (Ch: Char);
    Procedure   ProcessBuf (Var Buf; BufLen : Word);
    Procedure   SetReplyClient (Var Cli: TAbstractConsole);
  End;
...
Constructor TTermAnsi.Create (Var Con: TAbstractConsole);
Begin
  Inherited Create;
...
Procedure TTermAnsi.SetReplyClient (Var Cli: TAbstractConsole);
Begin
  Client := Cli;
End;
...
Begin
  Case Ch of
    ...
    'n'           : Begin
                      If Client <> NIL Then
                        ; // cursor position report skipped in cfg editor
