...
- [x] Full-Motion Video — MPEG-1 decoder (mpgdemux + mpgvdec + mpgvbuf + mpgplay + mpgstrm)
- [x] Document Oriented Interface — htmllayo.pas box model layout engine
- [x] HTML 1.0 Rendering — htmlpars + htmltree + htmllayo + htmlrip + htmlrend (5 units)
- [x] MIDI Synthesis — midisynth.pas FM synth (ported from v3, wired)
